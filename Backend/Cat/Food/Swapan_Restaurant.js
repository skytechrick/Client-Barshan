...
const Swapan_Restaurant = async (req, res) => {
    ...
    for (let i = 0; i < All.length; i++) {
        const element = All[i];
        if(element.Category == "FOOD Swapan's Restaurant"){
    ...
    if (Auths != null) {
        let Login = `
            ...
            `;
        res.status(200).render("Food_Swapan_Restaurant",{P:fin, NAV: Login, Script1:"HomeLog"});
        ...
        res.clearCookie("ID");
        res.status(200).render("Food_Swapan_Restaurant",{P:fin, NAV: a, Script1:"Home"});

    }
}
module.exports = Swapan_Restaurant;