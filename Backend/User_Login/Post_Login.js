...
const {getUserProfileOne, updateUserProfile} = require("../Models.js");
        ...
        if(true){
            if(BODY.Mess == "Hello developer/hacker"){
                ...
                if(D.Email == 1 && D.Password == 1){
                    ...
                    let d = await getUserProfileOne({Email:SA});
                    if (d == null) {
                        ...
                        if(match == true){
                            if (d.Verified == "Yes") {
                                ...
                                await updateUserProfile({_id:d._id},{$set:{Logs:Xa}})
                                ...
                                await updateUserProfile({_id:d._id},{
                                    $set:{
                                    Auth:{
                                        Auth_ID:Auth_Token1,
                                        OTP:OTP1,
