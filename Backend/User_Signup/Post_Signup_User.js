...
const Post_Signup_User = async(req,res)=>{
    if (req.cookies.Signup) {
        if(true){
            ...
            return res.status(200).redirect("http://zipbuy.in/");
        };
    }else{
